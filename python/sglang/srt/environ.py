...
class Envs:
    ...
    # Experimental pure-Triton replacement for DSV4 mhc_pre, including its
    # optional fused RMSNorm. It takes precedence over the TileLang path.
    SGLANG_OPT_USE_TRITON_MHC_PRE = EnvBool(False)
